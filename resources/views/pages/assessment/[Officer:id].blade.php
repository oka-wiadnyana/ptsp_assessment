                ...
                <div class="card h-100" style="background-image: url('{{ asset('img/bg-card.png') }}'); background-repeat:no-repeat; background-size: cover; border-radius: 10% " >
                    ...
                    <div class="card-body">
                        ...
                        <div class="row text-center d-flex flex-column align-items-center">
                            ...
                            <span class="h1 title text-white ">ASSESSMENT</span>
                            <img src="{{ asset('officer_image/'.$officer->foto) }}" alt="" style="border-radius: 50%">
                        ...
                        <form action="{{ route('result.insert') }}" method="POST">
                            ...
                            <div class="row justify-content-center py-2 rounded mb-2" >
                                <div class="col-10 d-flex justify-content-center" style="border-radius:10px; background-color: rgba(255,255,255,0.7)">
                            ...
                            <div class="row">
                                <div class="col d-flex justify-content-center">
                                    <button type="submit" class="btn btn-primary"><span class="h5 px-3">Kirim</span></button>
                                </div>
                            </div>
                        </form>
